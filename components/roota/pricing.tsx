...
export default function Pricing() {
    ...
    const plans = [
...

        {
            ...
            tag: t.pricing.plans[3].tag,
            ideal: t.pricing.plans[3].ideal,
            description: t.pricing.plans[3].description,
            cta: t.pricing.plans[3].cta,
            href: `/${locale}/contact`,
        },
    ]
