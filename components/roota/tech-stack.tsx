            ...
            "
              ...
              "
                ...
                <motion.h2
                    ...
                    viewport={{ once: true }}
                    className="mx-auto max-w-4xl text-center text-2xl font-black leading-tight text-black sm:text-3xl md:text-5xl"
                >
                    {t.techStack.title}
                </motion.h2>

                {/* STACK */}
                <div className="mt-16 flex flex-col items-center gap-10 md:mt-28 md:gap-16">
